...
def _build_saved_params(
    ...
    think_checkbox=False, lm_cfg_scale=1.0, lm_top_k=0, lm_top_p=0.9, lm_negative_prompt="",
    use_cot_metas=False, use_cot_caption=False, use_cot_language=False,
    constrained_decoding_debug=False, allow_lm_batch=False, auto_score=False, auto_lrc=False,
    score_scale=0.5, lm_batch_chunk_size=8,
    track_name="", complete_track_classes=None,
    enable_normalization=False, normalization_db=-1.0, fade_in_duration=0.0, fade_out_duration=0.0,
